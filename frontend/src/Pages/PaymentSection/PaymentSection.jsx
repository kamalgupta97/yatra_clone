    ...
    <div className={classes.root}>
      <div style={{ backgroundColor: "white" }}>
        <Toolbar className={classes.navData}>
          ...
          <div className={styles.nav_payment_section}>
            ...
            <div>
              <Typography>
                Hi {stateAuth.isAuth ? stateAuth.user : "user"}
              </Typography>
            </div>
          </div>
        </Toolbar>
      ...
      <Box className={classes.payment_modal}>
        ...
        <div className={styles.payment_Right_cont}>
                  ...
                  <div className={classes.dropdown}>
                    <div className={styles.booking_content}>
                      ...
                      <div style={{ padding: "5px 5px" }}>
                        ...
                        <p className={classes.color_para}>
                          {data.bus[0].bustype}
                        </p>
                      </div>
                      <div style={{ padding: "5px 5px" }}>
                        <h5>Seat No</h5>
                        <p className={classes.color_para}>
                          {selected_seats_data.selected.join(", ")}
                        </p>
                      </div>
                      <div style={{ padding: "5px 5px" }}>
          ...
          <div>
            <div className={styles.booking_summary}>Payment Details</div>
