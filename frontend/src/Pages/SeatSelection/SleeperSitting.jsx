...
import {totallowerseats,totalupperseats} from './requirement';
...
export const SleeperSitting = ({bustype,selected,booked,handleClick,activelower}) => {
        ...
        <div>
            {
                        ...
                        {activelower? totallowerseats.map((item)=>  
                        {
